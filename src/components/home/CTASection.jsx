        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <ScrollReveal>
            <h2 className="font-serif text-4xl lg:text-5xl xl:text-6xl font-semibold text-cream leading-tight mb-6">
              ...
              your companion to
              <br />
              <span className="italic text-terracotta">the best</span>?
            </h2>
            <p className="text-cream/50 text-lg max-w-md mb-8 leading-relaxed">
              Join 10,000+ pet parents who've upgraded their companion's lifestyle. Free shipping on your first order.
            </p>
