        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <motion.h1
              ...
              className="font-serif text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-semibold leading-[1.05] text-charcoal mb-6"
            >
              Where luxury
              <br />
              meets <span className="italic text-terracotta">loyalty</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-lg lg:text-xl text-charcoal/50 max-w-lg mb-10 leading-relaxed"
            >
              Thoughtfully crafted essentials for the modern pet — where Italian leather meets Japanese minimalism, and every detail honors your companion.
            </motion.p>
            ...
            <motion.div
              ...
              className="flex gap-10 mt-16 pt-10 border-t border-charcoal/10"
            >
              {[
