...
export default function AboutPage() {
  ...
  const bgImage = siteContent.bgAbout || 'https://images.unsplash.com/photo-1543466835-00a7907e9de1?w=1920&h=800&fit=crop'

  return (
    <main className="min-h-screen">
      <section className="relative pt-28 lg:pt-36 pb-20 lg:pb-28 bg-charcoal overflow-hidden">
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: `url(${bgImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
